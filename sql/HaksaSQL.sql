CREATE DATABASE Haksa default character set utf8mb4;
...
( BookRental_no int(10) primary KEY NOT NULL AUTO_INCREMENT, -- 대여번호
  ...
  BookRental_bDate date Default now(),
  BookRental_aDate Date Default now(),
...
INSERT INTO Majors(Major_id, Major_name) VALUES ('0000000002', '컴퓨터공학');
INSERT INTO Majors(Major_id, Major_name) VALUES ('0000000003', '뷰티학');
INSERT INTO Majors(Major_id, Major_name) VALUES ('0000000004', '환결공학');
INSERT INTO Majors(Major_id, Major_name) VALUES ('0000000005', '식품공학');
...
Select Student.Student_id, Student.Student_name, Majors.Major_name from Student, Majors where Student_dept = Major_id and Student_id = '1111111'
...
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000001', '멀티미디어디자인이해');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000001', 'UI/UX기획과설계');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000001', '안드로이드프로그래밍');

INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000002', '컴퓨터프로그래밍');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000002', '데이터구조');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000002', '정보컴퓨터교육론');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000002', '데이터베이스');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000002', '운영체제');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000002', '컴퓨터구조');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000002', '정보컴퓨터논리및논술');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000002', '컴퓨터네트워크');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000002', '프로그래밍언어론');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000002', '웹프로그래밍');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000002', '리눅스프로그래밍');

INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000003', '메디컬피부과학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000003', '기초메이크업');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000003', '해부생리학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000003', '바디페인팅');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000003', '기초네일케어');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000003', '응용네일케어');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000003', '무대분장');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000003', '의료미용기기관리');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000003', '보건의료법규');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000003', '메디컬비만체형관리');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000003', '풋테라피');

INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000004', '환결공학개론');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000004', '환결기초론');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000004', '구조역학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000004', '연소학개론');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000004', '소음및진동학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000004', '수질오염론');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000004', '환경화학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000004', '고형폐기물처리');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000004', '대기오염론');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000004', '산업위생학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000004', '철근콘크리트및강구조');

INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000005', '생화학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000005', '유기화학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000005', '식품화학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000005', '식품미생물학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000005', '물리화학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000005', '물성학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000005', '공정공학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000005', '발효식품학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000005', '포장공학');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000005', '기기분석및실험');
INSERT INTO Subjects(Subject_majId, Subject_name) VALUES('0000000005', '최신식품개발론');
